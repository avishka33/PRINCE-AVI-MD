1cb)+_0x3aaea2(0x1e3)+_0x3aaea2(0x1b1)},global[_0x3aaea2(0x1bf)]={'hitori':_0x3aaea2(0x1c1)+_0x3aaea2(0x1d2)+'w'},global[_0x3aaea2(0x1bb)]={'https://api.hitori.pw':_0x3aaea2(0x1c8)+_0x3aaea2(0x1d4)+_0x3aaea2(0x1d8),'geminiApikey':[_0x3aaea2(0x1d5)+_0x3aaea2(0x1bd)+_0x3aaea2(0x1d0)+_0x3aaea2(0x1c4),_0x3aaea2(0x1c6)+_0x3aaea2(0x1b8)+_0x3aaea2(0x1db)+_0x3aaea2(0x1cc),_0x3aaea2(0x1be)+_0x3aaea2(0x1e0)+_0x3aaea2(0x1c3)+_0x3aaea2(0x1c2),_0x3aaea2(0x1b3)+_0x3aaea2(0x1b9)+_0x3aaea2(0x1b0)+_0x3aaea2(0x1de),_0x3aaea2(0x1c9)+_0x3aaea2(0x1c7)+_0x3aaea2(0x1b7)+_0x3aaea2(0x1dd)]});
...
const templateMenu = require('./lib/ntemplate_menu');
...
module.exports = Avishka = async (Avishka, m, msg, store, groupCache) => {
	try {
		...
		const ucapanWaktu = jam < '05:00:00' ? 'Good Morning 🌄' :
        jam < '11:00:00' ? 'Good Morning 🌄' : 
		jam < '15:00:00' ? 'Good Afternoon 🌅' :
		jam < '18:00:00' ?'Good Evening 🌃' : 
		jam < '19:00:00' ? 'Good Evening 🌃' :
		jam < '23:59:00' ?  'Good Night ☄️' : 'Good Night ☄️';
...
async function xnxxdl(URL) {
  return new Promise((resolve, reject) => {
	...
	//bug not working its old we add soon new working bus...
...
//-------------------------------------
		...
		if (set.autobio) {
			if (new Date() * 1 - set.status > 60000) {
				await Avishka.updateProfileStatus(`${Avishka.user.name} | 🎯 Runtime : ${runtime(process.uptime())}`).catch(e => {})
					...
					if (jamSholat === waktu && this.waktusholat[sholat] !== hariIni) {
						...
						for (const [idnya, settings] of Object.entries(db.groups)) {
							if (settings.waktusholat) {
								await Avishka.sendMessage(idnya, { text: ` *${sholat}* the time for prayer has arrived, take ablution water and immediately pray🙂.\n\n*${waktu.slice(0, 5)}*\n_areas._` }, { ephemeralExpiration: m.expiration || store?.messages[idnya]?.array?.slice(-1)[0]?.metadata?.ephemeralDuration || 0 }).catch(e => {})
							}
						}
					}
				}
		...
		if (db.users[m.sender].afkTime > -1) {
			...
			m.reply(`@${m.sender.split('@')[0]} berhenti AFK${user.afkReason ? ' after ' + user.afkReason : ''}\nDuring ${clockString(new Date - user.afkTime)}`)
			user.afkTime = -1
			user.afkReason = ''
		}
		...
		switch(command) {
			...
			case 'setppbot': {
				...
				let media = await Avishka.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
				if (text.length > 0) {
					...
					await Avishka.updateProfilePicture(botNumber, { url: media })
					await fs.unlinkSync(media)
					m.reply('Success')
				}
			}
			...
			case 'upsw': {
				...
				try {
					if (quoted.isMedia) {
						...
						await Avishka.sendMessage('status@broadcast', { text: text || m.quoted?.body || '' }, {
							textArgb: 0xffffffff,
			...
			case 'deletesampah': case 'delsampah': {
				...
				fs.readdir('./database/sampah', async function (err, files) {
					...
					let teks = `Detected ${filteredArray.length} Sampah file\n\n`
					if(filteredArray.length == 0) return m.reply(teks);
					filteredArray.map(function(e, i) {
						teks += (i+1)+`. ${e}\n`
					})
			...
			case 'setppgroups': case 'setppgrup': case 'setppgc': {
				...
				if (!/image/.test(quoted.type)) return m.reply(`Reply Image Dengan Caption ${prefix + command}`)
				let media = await Avishka.downloadAndSaveMediaMessage(quoted, 'ppgc.jpeg')
				if (text.length > 0) {
					let { img } = await generateProfilePicture(media)
					await Avishka.query({
						tag: 'iq',
					...
					await Avishka.updateProfilePicture(m.chat, { url: media })
					await fs.unlinkSync(media)
					m.reply('Success')
				}
			}
			...
			case 'delete': case 'del': case 'd': {
				...
				await Avishka.sendMessage(m.chat, { delete: { remoteJid: m.chat, fromMe: m.isBotAdmin ? false : true, id: m.quoted.id, participant: m.quoted.sender }})
			}
			break
			case 'pin': case 'unpin': {
				if (!m.isGroup) return m.reply(mess.group)
			...
			break
			case 'runtime': case 'avi': case 'bot': {
				switch(args[0]) {
				...
				if (!args[0] && !args[1]) return m.reply(`𝙷𝙸 👋🏻 𝙸'𝙼 𝙰𝚅𝙸 🥷🏻 𝙷4𝙲𝙺3𝚁 𝚃𝙴𝙰𝙼 MEMBER 🗡️ *${runtime(process.uptime())}* `)
			}
			break
 ...
 ┖━━━━━━━━━━⪩`
			...
			break
			case 'oneview': case 'viewone': case '1more': {
...
case 'ytmp3': {
 ...
 /*|⬡════════════════════════════════════════════|❝   𝙰vi -  ™ ❞|═══════════════════════════════════════════⬡|*/    
		  case 'donas': case 'd': {
			...
			break
 /*|⬡════════════════════════════════════════════|❝   𝙰vi -  ™ ❞|═══════════════════════════════════════════⬡|*/    		
		    case 'gm': case 'g.m': case 'morning':
     
        Avishka.sendMessage(m.chat, {
          text: `* සුභ උදෑසනක් වේවා ! \n \n \n `,
          contextInfo: {
            externalAdReply: {
              showAdAttribution: true,
              title: `${botname}`,
 ...
 /*|⬡════════════════════════════════════════════|❝   𝙰vi -  ™ ❞|═══════════════════════════════════════════⬡|*/    
		 case 'mk':  case 'mm':
          Avishka.sendMessage(m.chat, {
            ...
            ,
            Avishka.sendMessage(m.chat, {
              audio: { url: 'https://files.catbox.moe/iln8c5.mp3' },
              mimetype: 'audio/mp4',
              ptt: true
            }, { quoted: m }
            );
...
/*|⬡════════════════════════════════════════════|❝   𝙰vi -  NSFW IMAGE	  ™ ❞|═══════════════════════════════════════════⬡|*/
		...
		case 'yuri':
			    var ahegaonsfw = JSON.parse(fs.readFileSync('./AMedia/nsfw/yuri.json'))
			    var Aviresult = pickRandom(ahegaonsfw)
		    	Avishka.sendMessage(m.chat, { caption: mess.success, image: { url: Aviresult.url } }, { quoted: m })
			    break
...
/*|⬡════════════════════════════════════════════|❝   𝙰vi -  Anime  ™ ❞|═══════════════════════════════════════════⬡|*/
			...
			case 'allmenu': case 'menu': m.react('✈'); m.react('✈');{
